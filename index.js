// import {Rocket, RocketSimulation} from "./rocketsim"
...
const times = simulation.results.map(result => result.time);
const altitudes = simulation.results.map(result => result.altitude);
const velocities = simulation.results.map(result => result.velocity);
const accelerations = simulation.results.map(result => result.acceleration);
